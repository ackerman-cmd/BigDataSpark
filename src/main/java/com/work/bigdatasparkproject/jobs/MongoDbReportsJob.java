...
import com.work.bigdatasparkproject.config.SparkConfigMongo;
import org.apache.spark.sql.Dataset;
import org.apache.spark.sql.Row;
import org.apache.spark.sql.SparkSession;

public class MongoDbReportsJob {
    public static void main(String[] args) {
        try (SparkSession spark = SparkConfigMongo.createSparkSession()) {
            spark.conf().set("spark.sql.legacy.timeParserPolicy", "LEGACY");
            String pgUrl = "jdbc:postgresql://postgres:5432/sales_db";
            String pgUser = "admin";
            String pgPassword = "secret";
            String mongoUri = "mongodb://user:pass@mongo-db:27017/sales_db?authSource=sales_db";
            spark.conf().set("spark.mongodb.output.uri", mongoUri);
            ...
            try {
                ...
                System.out.println("Creating sales by product mart...");
                ...
                salesByProduct.write()
                        .format("mongodb")
                        .option("uri", "mongodb://user:pass@mongo-db:27017/sales_db?authSource=sales_db")
                        .option("database", "sales_db")
                        .option("collection", "sales_by_product")
                        .option("serverSelectionTimeoutMS", "60000")
                        .mode("overwrite")
                        .save();

                System.out.println("Creating sales by customer mart...");
                ...
                salesByCustomer.write()
                        ...
                        .option("collection", "sales_by_customer")
                        .mode("overwrite")
                        .save();

                System.out.println("Creating sales by time mart...");
                ...
                salesByTime.write()
                        ...
                        .option("uri", mongoUri)
                        .option("database", database)
                        .option("collection", "sales_by_time")
                        .mode("overwrite")
                        .save();

                System.out.println("Creating sales by store mart...");
                ...
                salesByStore.write()
                        ...
                        .option("uri", mongoUri)
                        .option("database", database)
                        .option("collection", "sales_by_store")
                        .mode("overwrite")
                        .save();

                System.out.println("Creating sales by supplier mart...");
                ...
                salesBySupplier.write()
                        ...
                        .option("uri", mongoUri)
                        .option("database", database)
                        .option("collection", "sales_by_supplier")
                        .mode("overwrite")
                        .save();

                System.out.println("Creating product quality mart...");
                ...
                productQuality.write()
                        ...
                        .option("uri", mongoUri)
                        .option("database", database)
                        .option("collection", "product_quality")
                        .mode("overwrite")
                        .save();
