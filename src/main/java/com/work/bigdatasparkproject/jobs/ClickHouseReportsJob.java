...
public class ClickHouseReportsJob {
    public static void main(String[] args) {
        try (SparkSession spark = SparkConfig.createSparkSession()) {
            ...
            String chUrl = "jdbc:ch://clickhouse-db:8123/sales_db";
            String chUser = "admin";
            String chPassword = "secret";
            ...
            try {
                ...
                salesByProduct.write()
                        .format("jdbc")
                        .option("url", chUrl)
                        .option("dbtable", "sales_by_product")
                        .option("user", chUser)
                ...
                salesByCustomer.write()
                        .format("jdbc")
                        .option("url", chUrl)
                        .option("dbtable", "sales_by_customer")
                        .option("user", chUser)
                        .option("password", chPassword)
                        .option("driver", "com.clickhouse.jdbc.ClickHouseDriver")
                        .mode(SaveMode.Append)
                ...
                salesBySupplier.write()
                        .format("jdbc")
                        .option("url", chUrl)
                        .option("dbtable", "sales_by_supplier")
                        .option("user", chUser)
                        .option("password", chPassword)
                        .option("driver", "com.clickhouse.jdbc.ClickHouseDriver")
                        .mode(SaveMode.Append)
                ...
                productQuality.write()
                        .format("jdbc")
                        .option("url", chUrl)
                        .option("dbtable", "product_quality")
                        .option("user", chUser)
                        .option("password", chPassword)
                        .option("driver", "com.clickhouse.jdbc.ClickHouseDriver")
                        .mode(SaveMode.Append)
